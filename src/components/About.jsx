        ...
        >
            ...
            >
                <div>
                    ...
                    <a
                        href="https://www.linkedin.com/in/dillon-s-williams/"
                        target="_blank"
                        rel="noreferrer"
                    >
                        <ReactRoundedImage
                ...
                >
                    ...
                    <p style={{ fontSize: "20px" }}>
                        Specialization in web development, low-level systems,
                    ...
                    <p style={{ fontSize: "20px", color: "orange" }}>
                        BS in Computer Science from Oklahoma State University!
                    </p>
                    <p
                        style={{
                            color: "white",
